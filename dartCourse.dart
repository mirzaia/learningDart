...
// beratMammal = beratMammal - 2;
  ...
  void jalan(){
bergerak = true;
    print("$namaMammal sedang bergerak di $habitat dengan menggerakan $kakiMammal kakinya");
  }
  void berhenti(){
bergerak = false;
    print('berhenti');
...
enum enviRonment {
  rock, leaf, wind, fire, water, air
}
enum campaignStatus {
  completed, in_progress, forbidden
}
...
// String Interpolation
  ...
  print('A goal from $stringInterpolation'); // menambahkan variabel tanpa '+' hanya butuh '$'

// Mengabaikan interpolation
print(r'The price reach as high as $1111'); // r untuk mengabaikan interpolation
print(" ");
...
*/
  ...
  // LIST
  List daftarMobil = ['avanzaa', 'xenia', 'fortuner', 'agya', 'pajero', 'crown', 'corolla', true, false, false, true, 'hilux', 'land cruiser'];
  print(daftarMobil[1]);
  var y;
  for (y=0; y<4; y++){
    print(daftarMobil[y]);
  ...
  print('\r\n');
  daftarMobil.forEach((x) => print(x));
  List daftarMotor = ['tiger', 'vario', 'beat', 'verza', 'scoopy', 'revo', 'mio'];
  ...
  void otherHigherOrderFunction(String justPrint, Function(int aha1, int aha2) theFunction){
    print(justPrint);
    print(theFunction(5,5));
  }
  var fibonacci = [1,2,4,7,11,16,22,29];
  fibonacci.forEach((zz) {print(zz);});
